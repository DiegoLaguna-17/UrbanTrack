...
import 'package:urban_track/Cliente/Respuestas/respuestaEncuesta.dart';
...
Widget build(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RespuestasPage(idCliente: this.idCliente,idEncuesta: this.idEncuesta,titulo:this.titulo)
      ),
    );
