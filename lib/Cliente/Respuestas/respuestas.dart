...
import 'package:urban_track/Cliente/Respuestas/cardEncuesta.dart';
import 'dart:convert'; 
import 'package:http/http.dart' as http;

class RespuestasTab extends StatefulWidget {
  final int idCliente;
  const RespuestasTab({required this.idCliente, super.key});

  @override
  State<RespuestasTab> createState() => _RespuestasTabState();
}

class _RespuestasTabState extends State<RespuestasTab> {
  String searchQuery = "";
  ...
  Future<void> fetchEncuestas() async {
    ...
    final url =
        'https://utbackend-xn26.onrender.com/encuestas/cliente/$id/respondidas'; 
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return EncuestaCard(
                ...
                idEncuesta: int.parse(encuesta["id"]!),
